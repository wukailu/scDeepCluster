...
def encoder(h, dims, noise_sd=0.0, init='glorot_uniform', act='relu', dense=None, source=None):
    if not dense:
        dense = args.dense
    his = h
...
def decoder(h, dims, noise_sd=0.0, init='glorot_uniform', act='relu', dense=None, source=None):
    if not dense:
        dense = args.dense
    his = h
